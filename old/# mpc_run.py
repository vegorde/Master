...
if __name__ == "__main__":
    ...
    waypoints = [
        ...
        (102.000, 4.000, 10.000),
        (104.000, 4.000, 10.000),
        (106.000, 4.000, 10.000),
        (108.000, 4.000, 10.000),
        (110.000, 4.000, 10.000),
        (112.000, 4.000, 10.000),
        (114.000, 4.000, 10.000),
        (116.000, 4.000, 10.000),
        (118.000, 4.000, 10.000),
        (120.000, 4.000, 10.000),
        (122.000, 4.000, 10.000),
        (124.000, 4.000, 10.000),
        (126.000, 4.000, 10.000),
        (128.000, 4.000, 10.000),
        (130.000, 4.000, 10.000),
        (132.000, 4.000, 10.000),
        (134.000, 4.000, 10.000),
        (136.000, 4.000, 10.000),
        (138.000, 4.000, 10.000),
        (140.000, 4.000, 10.000),
        (142.000, 4.000, 10.000),
        (144.000, 4.000, 10.000),
        (146.000, 4.000, 10.000),
        (148.000, 4.000, 10.000),
        (150.000, 4.000, 10.000),
    ]
    ...
    plt.plot(ts, np.rad2deg(deltas_mesured), label = "mesured")
    plt.xlabel("time [s]")
